...
*/
#define BSP_CFG_MCU_PART_VERSION        (0xB) /* Generated value. Do not edit this manually */
...
/* Group name.
   ...
   61           = RX261 Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX261" /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_USB_CLOCK_SOURCE        (6) /* Generated value. Do not edit this manually */
...
/* CANFD Clock source select (CANFDCKSEL). Choose which clock source to input to the CANFD circuit.
   ...
   6 = PLL 2 Circuit
*/
#define BSP_CFG_CANFD_CLOCK_SOURCE      (5) /* Generated value. Do not edit this manually */
...
/* Sub clock Oscillator Switching (SOSEL).
   ...
   1 = External clock input
*/
#define BSP_CFG_SUB_CLOCK_SOURCE        (0) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_USB_CLOCK_ENABLE        (1) /* Generated value. Do not edit this manually */

/* CANFD Clock supply control (CANFDCKSREQ).
   0 = Stop clock supply to CANFD.
   1 = Supply clock to CANFD. (default)
*/
#define BSP_CFG_CANFD_CLOCK_ENABLE      (1) /* Generated value. Do not edit this manually */
...
/* PLL2 Input Frequency Division Ratio Select (PLIDIV).
   Available divisors = /1 (no division), /2, /4
*/
#define BSP_CFG_PLL2_DIV                (1) /* Generated value. Do not edit this manually */

/* PLL2 Frequency Multiplication Factor Select (STC).
   Available multipliers = x4.0 to x15.5 in 0.5 increments (e.g. 4.0, 4.5, 5.0, ..., 14.5, 15.0, 15.5)
*/
#define BSP_CFG_PLL2_MUL                (8) /* Generated value. Do not edit this manually */

/* System Clock Divider (ICK).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_ICK_DIV                 (4) /* Generated value. Do not edit this manually */
...
/* Flash IF Clock Divider (FCK).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_FCK_DIV                 (64) /* Generated value. Do not edit this manually */

/* CANFD Clock Divider Select (CANFDCKDIV).
   Available divisors = /1 (no division), /2, /4, /8
*/
#define BSP_CFG_CFDCK_DIV               (2) /* Generated value. Do not edit this manually */
